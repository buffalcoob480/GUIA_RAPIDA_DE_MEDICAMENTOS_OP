...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const familyConfig = {
        ...
        'Antibióticos': { color: 'card-color-antibioticos', lottie_url: 'https://assets4.lottiefiles.com/packages/lf20_9xRnlq.json' },
        ...
        'Gastrointestinales': { color: 'card-color-gastrointestinales', lottie_url: 'https://assets3.lottiefiles.com/packages/lf20_32M3n7.json' },
        'Antidiabéticos': { color: 'card-color-antidiabeticos', lottie_url: 'https://assets1.lottiefiles.com/packages/lf20_T0T5mG.json' },
        'Analgésicos': { color: 'card-color-analgesicos', lottie_url: 'https://assets4.lottiefiles.com/packages/lf20_9xRnlq.json' },
        'Antialérgicos': { color: 'card-color-respiratorios', lottie_url: 'https://assets4.lottiefiles.com/packages/lf20_2d9j82.json' },
        'Antiinflamatorios': { color: 'card-color-analgesicos', lottie_url: 'https://assets1.lottiefiles.com/packages/lf20_1yy08AEs5E.json' },
        'Dermatológicos': { color: 'card-color-default', lottie_url: 'https://assets2.lottiefiles.com/packages/lf20_jpxs3k.json' },
        'Neurológicos': { color: 'card-color-gastrointestinales', lottie_url: 'https://assets6.lottiefiles.com/packages/lf20_fxk0y9.json' },
        'Oftalmológicos': { color: 'card-color-antibioticos', lottie_url: 'https://assets9.lottiefiles.com/packages/lf20_x8slt6.json' },
        'default': { color: 'card-color-default', lottie_url: 'https://assets9.lottiefiles.com/packages/lf20_p7o1s2.json' }
    };
